...
- App fetches user data from GitHub API
- Shows loading animation
- UI updates dynamically with profile info
- If username is invalid → “User Not Found” message
